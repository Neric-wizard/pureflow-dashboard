      ...
      <div className="flex items-center gap-3">
        <div className="w-8 h-8 bg-blue-500/20 border border-blue-500/30 rounded-lg flex items-center justify-center">
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            <path d="M9 2C9 2 3.5 8 3.5 11.5a5.5 5.5 0 0011 0C14.5 8 9 2 9 2z"
              fill="rgba(61,142,240,0.25)" stroke="#3d8ef0" strokeWidth="1.3"/>
            <path d="M6.5 12.5c.5 1.5 2 2 3 1.5"
              stroke="#1fd18a" strokeWidth="1.1" strokeLinecap="round"/>
          </svg>
        </div>
        <div>
